...
/** Public asset under Vite `base` (avoids double slashes). */
...
export async function loadAvailableDays(): Promise<DayOption[]> {
  const res = await fetch(publicUrl("data/available_days.json"));
